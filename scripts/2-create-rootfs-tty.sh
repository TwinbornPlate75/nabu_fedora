...
# ==============================================================================
# 2-create-rootfs-tty.sh
#
# 功能: 在基础 rootfs 之上安装一个无桌面环境的 TTY 版本，并打包成最终的镜像文件。
#       适用于只需要命令行使用的场景。
#
# 作者: jhuang6451 TwinbornPlate75
# 版本: 2.0
# ==============================================================================
...
# --- 安装软件包和配置 ---
# ==========================================================================
echo "Installing standard and terminal tools..."
dnf install -y \
...
echo "============================================================================="
echo "✅ Compressed TTY rootfs image created successfully: $ROOTFS_COMPRESSED_NAME"
echo "============================================================================="
